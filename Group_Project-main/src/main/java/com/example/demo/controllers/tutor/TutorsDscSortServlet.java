...
@WebServlet(name = "TutorDscSortServlet", value = "/sort-tutor-dsc")
public class TutorsDscSortServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // insert array items to arrayLists DSC
        for (int i = tutorArr.length-1; i > -1; i--) {
            visibleTutors.add(tutorArr[i]);
        }
